    ...
    steps: [
      ...
      },
      {
        position: [
          ...
          [null, null, null, null, 'black-pawn', null, null, null],
          [null, null, null, null, 'white-pawn', null, null, null],
          [null, null, null, null, null, 'white-bishop', null, null],
          ['white-pawn', 'white-pawn', 'white-pawn', 'white-pawn', null, 'white-pawn', 'white-pawn', 'white-pawn'],
        ...
        move: '2. Bc4',
        lastMove: { from: [7, 5], to: [5, 5] },
      },
      {
        position: [
          ['black-rook', 'black-knight', 'black-bishop', 'black-queen', 'black-king', 'black-bishop', null, 'black-rook'],
          ['black-pawn', 'black-pawn', 'black-pawn', 'black-pawn', null, 'black-pawn', 'black-pawn', 'black-pawn'],
          [null, null, null, null, null, 'black-knight', null, null],
          [null, null, null, null, 'black-pawn', null, null, null],
          [null, null, null, null, 'white-pawn', null, null, null],
          [null, null, null, null, null, 'white-bishop', null, null],
          ['white-pawn', 'white-pawn', 'white-pawn', 'white-pawn', null, 'white-pawn', 'white-pawn', 'white-pawn'],
        ...
        description: 'Black develops the knight to f6.',
        move: '2... Nf6',
      ...
      },
      {
        position: [
          ...
          [null, null, null, null, 'black-pawn', null, null, null],
          [null, null, null, null, 'white-pawn', null, null, null],
          [null, null, null, null, null, 'white-bishop', null, 'white-queen'],
          ['white-pawn', 'white-pawn', 'white-pawn', 'white-pawn', null, 'white-pawn', 'white-pawn', 'white-pawn'],
      ...
      },
      {
        position: [
          ...
          [null, null, null, null, 'black-pawn', null, null, null],
          [null, null, null, null, 'white-pawn', null, null, null],
          [null, null, 'black-knight', null, null, 'white-bishop', null, 'white-queen'],
          ['white-pawn', 'white-pawn', 'white-pawn', 'white-pawn', null, 'white-pawn', 'white-pawn', 'white-pawn'],
          ['white-rook', 'white-knight', 'white-bishop', null, 'white-king', null, 'white-knight', 'white-rook'],
        ],
        description: 'Black plays Nc6, developing a piece but missing the threat.',
        move: '3... Nc6',
        lastMove: { from: [0, 1], to: [5, 2] },
      },
      {
        position: [
          ['black-rook', 'black-knight', 'black-bishop', 'black-queen', 'black-king', 'black-bishop', null, 'black-rook'],
